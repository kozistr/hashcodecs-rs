...
Python hashcodecs measurements use the CPython 3.12 version-specific wheel and
its full C API. Unchanged reference series are retained from their latest clean run.
