    ...
    Chart(
        ...
        (
            panel(
                'Standard encode',
                SIZES,
                hashcodecs=[25.77, 34.66, 39.50, 29.17],
            ...
            panel(
                'Standard decode',
                SIZES,
                hashcodecs=[16.77, 22.82, 27.06, 15.90],
                base64=[3.51, 3.85, 3.54, 3.85],
                base64_turbo=[11.19, 13.73, 13.20, 12.52],
            ),
            panel(
                'URL-safe encode',
                SIZES,
                hashcodecs=[25.75, 34.65, 39.54, 29.26],
            ...
            panel(
                'URL-safe decode',
                SIZES,
                hashcodecs=[16.52, 21.95, 24.00, 16.20],
                base64=[3.51, 3.71, 3.59, 3.71],
                base64_turbo=[11.55, 13.74, 13.78, 12.34],
            ),
        ),
    ),
    Chart(
