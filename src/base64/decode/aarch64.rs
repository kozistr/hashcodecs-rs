//! AArch64 NEON decoding kernel.

use std::arch::aarch64::*;

use super::super::Base64Error;
use super::tables::{
    MIXED_LOW_CLASSES, MIXED_OFFSETS, STANDARD_HIGH_CLASSES, STANDARD_LOW_CLASSES,
    STANDARD_OFFSETS, URLSAFE_HIGH_CLASSES, URLSAFE_LOW_CLASSES, URLSAFE_OFFSETS,
};
